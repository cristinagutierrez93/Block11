...
//     for (let numOfZombiesBlasted =1; numOfZombiesBlasted <= numOfDetectedZombies; numOfZombiesBlasted ++)
//     console.log("Directing " + numOfTurrets + " turrets' fire to zombie # " + numOfZombiesBlasted + ".");
// }

// directTurretDefenceCommand (10,10)
...
//     for(let indexNumOfCurrSupply=0; indexNumOfCurrSupply < suppliesToLookFor.length; indexNumOfCurrSupply ++){
//             console.log ("Jarvis has found some" + suppliesToLookFor[indexNumOfCurrSupply]+ ".")
//     }
